...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of XKProjectModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xk/XKProjectModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xk' => 'weikun.xie@get88.cn' }
  s.source           = { :git => 'https://github.com/xk/XKProjectModule.git', :tag => s.version.to_s }
